...
function setupEventListeners() {
  ...
  document.getElementById('filter-category').addEventListener('change', renderApp); // カテゴリ(JRA/地方/海外)
